...
<div class="container">
    ...
    <div class="button-group">
        <button class="btn" onclick="fetchRobotData()">Làm Mới Dữ Liệu</button>
        <button class="btn" onclick="exportCSV()">Xuất Báo Cáo CSV</button>
        <button class="btn" onclick="startRobot()">Bắt Đầu Robot</button>
        <button class="btn" onclick="stopRobot()">Dừng Robot</button>
...
<script>
    ...
    function fetchRobotData() {
        ...
        fetch('get_robot_data.php')
            ...
            .then(data => {
                ...
                document.getElementById('distance').innerText = (data.distance * 100) + ' cm';
                document.getElementById('energy').innerText = data.energy + ' J';
                let efficiency = ((data.distance * 100) / data.energy).toFixed(2);
                document.getElementById('efficiency').innerText = efficiency + ' cm/J';

                chartData.labels.push(currentTime);
                chartData.datasets[0].data.push(data.distance * 100);
                ...
                newRow.insertCell(1).innerText = (data.distance * 100) + ' cm';
    ...
    function startRobot() {
        fetch('start_robot.php');
    }

    function stopRobot() {
        fetch('stop_robot.php');
    }
