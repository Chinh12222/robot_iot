...
<div class="container">
    ...
    <!-- Thêm hình ảnh robot -->
    <div class="robot-img">
        <img src="/images/robot.png" alt="Robot Chạy Line" style="width:100px;">
    </div>
...
<script>
    ...
    function exportCSV() {
        ...
        link.setAttribute('download', 'robot_history.csv');
    ...
    function startRobot() {
        console.log("Robot bắt đầu chạy");
    }

    function stopRobot() {
        console.log("Robot đã dừng");
    }
